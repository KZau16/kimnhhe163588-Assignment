...
public class ProfileControl extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        DAO d = new DAO();
        Role r = d.getRoleByName(role);
        String srole = Integer.toString(r.getId());
        d.editUser(uname, name, pass, gmail, pnum, address, srole);
        response.sendRedirect("profile?aid="+uname);
    }
